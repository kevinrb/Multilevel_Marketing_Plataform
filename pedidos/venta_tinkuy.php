<?php
	...
	$result=posturl(array("a"=>"stock_local","local"=>$Xlocal),"http://perushop.pe/santa2/webservices/pedidos.php");
	...
	/*
		...
		{
		while($temp=mysql_fetch_row($res)){
		$html .= "<button inf='$temp[0]' class='btn btn-info ped'>Pedido $temp[0]</button>";
		}
	}*/
	...
	<body>
		<div class="container">
			...
			<div class="row">
				...
				-->
				<?php if($Xtinkuy==0){
					echo "<button class='btn btn-default btn-sm btn-success' id='tinkuy' type='button'>
					ACTIVAR TINKUY
					</button>";	
					}elseif($Xtinkuy==3){
					echo "<strong>ESPERA LA CONFIRMACION DE SU ACTIVACION</strong>";
				}?>
			...
			<div class="row">
				<div class="panel panel-success">
					<div style="height:48px;" class="panel-heading">Lista Productos <strong>(<?php echo "Monto Acumulado Mensual: S/.".$Xtin_acumu;?>)</strong></div> 
			...
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header"> 
						<h3 class="modal-title" id="myModalLabel">Informacion del Pago (Monto Acumulado:<span id="acum"></span>)</h3>
					</div>
								...
								<div class="row">
									<div class="col-sm-12">
										<div class="col-sm-12">
											...
											<div class="form-group adic"><label for="razon">Razon Social*</label><input required class="form-control input-sm dataruc" onkeyup="javascript:this.value=this.value.toUpperCase();" type="text" name="razon" id="razon" value=""></div>
											<div class="form-group adic"><label for="dir_ruc">Direccion*</label><input required class="form-control input-sm dataruc" onkeyup="javascript:this.value=this.value.toUpperCase();" type="text" name="dir_ruc" id="dir_ruc" value=""></div>
			...
			$(window).load(function(){
				...
				$("#conf").click(function(){
					if($(".list").length>0){
						...
						////calculo de niveles//
						$.post("../res/pedidos/venta_canales_auto.php",{a:'descuento_tinkuy',i:idbol},function(data){
							$(".desc").html(data.text);
							$("#acum").text(data.acum);
					...
					if(r==true){
						...
						$.post("../res/pedidos/venta_canales_auto.php",{
							...
							/*idcli:$("#vend1").val(),
								...
								dis:dis,
							ruc:ruc*/
							idruc:idruc ,razon:razon ,dir_ruc:dir_ruc ,ruc:ruc ,dir:dir ,ref:ref ,depa:depa ,prov:prov ,dist:dist ,iddest:iddest,tpago:tpago,pago:pago,transp:transp
							},function(data){
							btn.button('reset');
				...
				$("#apenv").click(function(){
					...
					$.post("../res/pedidos/venta_canales_auto.php",{a:"calcenv_tinkuy",dir:dir,ref:ref,dep:dep,pro:pro,dis:dis,i:idbol,tip:"u",iddest:iddest},
					function(data){
						$("#savev").prop("disabled",false);
						$("#totpeso").val(data[2]);
						$("#totenv").val(data[1]);
				...
				$("#tinkuy").click(function(){
					
					$("#canc").click();
					setTimeout(function(){
						$("#busq").val("afilia").keyup();
						$(".resultlist[idpr='7967']").addClass("resultselect").click();
						$("#addprod").click();
						setTimeout(function(){$("#conf").click()},500);
					},500);
