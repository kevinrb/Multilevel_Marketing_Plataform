$(document).ready(function(){
	...
	$("body").on("change","#clamotivo", function(){
		var valu=$(this).val();
		$.post("ajax/interfaz_ajaxnew_rec.php",{tipo:"motivo",val:valu},function(data){
			$("#idmotivo").html(data);
		})
	});
...
$("body").on("click",".call", function(){
	...
	$.post("ajax/interfaz_ajaxnew_rec.php", {recall:tel, idops:ido,save:1 }, function(data){
	$("#fono3").val(data);
	llamar(tel,ido,but);
	});
...
$("body").on("click",".call1", function(){
	...
	$.post("ajax/interfaz_ajaxnew_rec.php", {recall:tel, idops:ido }, function(data){
	llamar1(tel,ido,but);
	});
...
$("body").on("click",".cancel", function(){
	...
	$.post("ajax/interfaz_ajaxnew_rec.php", {accion:"colgar", idops:ido }, function(data){
	});
});
