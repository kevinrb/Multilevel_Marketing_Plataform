		...
		<script>
			...
			$(window).load(function(){
				...
				$("#vend1").change(function(){
					$.post("../res/pedidos/venta_canales.php",{a:'descuento_general',i:idbol,socio:$(this).val()},function(data){
						$(".desc").html(data.text);
				...
				$(document).on("click","#transp",function(){
					if($("#transp").is(':checked')){
						...
						/*$.post("../res/pedidos/venta_canales.php",{a:'descuento_transporte_general',i:idbol,socio:$("#vend1").val()},function(data){
							$(".desc").html(data.text);
							$("#totmon").val(data.total);
							$("#totpeso").val(parseFloat(data.peso));
							//alert(parseFloat(data.peso));
						...
						$("#totenv").val(0);
						/*$.post("../res/pedidos/venta_canales.php",{a:'descuento_general',i:idbol,socio:$("#vend1").val()},function(data){
							$(".desc").html(data.text);
							$("#totmon").val(data.total);
							$("#totpeso").val(parseFloat(data.peso));
							//alert(parseFloat(data.peso));
