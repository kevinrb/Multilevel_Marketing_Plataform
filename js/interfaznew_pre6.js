$(document).ready(function(){
	...
	$("body").on("change","#clamotivo", function(){
		var valu=$(this).val();
		$.post("ajax/interfaz_ajaxnew_pre.php",{tipo:"motivo",val:valu},function(data){
			$("#idmotivo").html(data);
		})
	});
...
//I. PRINCIPAL: SELECCION DE CAMPAÑA
	...
	//SE TRAEN LOS DATOS 
	$.post("ajax/interfaz_ajaxnew_pre.php", {cp:'listo',origen:origen}, function(data){
		$('#myTab').show();
		//$("#datos").empty();
		
		$("#datos").prepend(data.datos);
		$("#datos").prepend("<h2>Datos de cliente</h2>");
...
$("form").submit(function() {
	...
	if($("#idmotivo").val()!=0){
		...
		window.location.href = "interfaznew3.php";
},"json");
...
$("body").on("click",".call", function(){
	...
	$.post("ajax/interfaz_ajaxnew_pre.php", {recall:tel, idops:ido,save:1 }, function(data){
	$("#fono3").val(data);
	llamar(tel,ido,but);
	});
...
$("body").on("click",".call1", function(){
	...
	$.post("ajax/interfaz_ajaxnew_pre.php", {recall:tel, idops:ido }, function(data){
	llamar1(tel,ido,but);
	});
...
$("body").on("click",".cancel", function(){
	...
	$.post("ajax/interfaz_ajaxnew_pre.php", {accion:"colgar", idops:ido }, function(data){
	});
});
